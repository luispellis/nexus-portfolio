...
const coreTechnologies = ["Java", "Spring Boot", "REST APIs", "SQL", "Git", "Programação Orientada a Objetos"];
const expandingTechnologies = ["Python", "AWS", "Automação"];
...
export function About() {
  return (
    <section className="relative scroll-mt-20 py-20 sm:py-24 lg:py-28" id="about" aria-labelledby="about-title">
      <div
        aria-hidden="true"
      ...
      <SiteContainer>
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
          <header className="lg:col-span-5 lg:pt-8">
            <p className="font-mono text-xs font-medium uppercase tracking-[0.16em] text-gold">PERFIL</p>
            <h2
          ...
          <aside className="relative border border-card bg-card p-6 backdrop-blur-md sm:p-8 lg:col-span-7 lg:self-start lg:p-10" aria-label="Detalhes do perfil">
            ...
            <p className="font-mono text-xs font-medium uppercase tracking-[0.16em] text-cyan">Momento profissional</p>
            <dl className="mt-6 grid gap-6 border-y border-card py-6 sm:grid-cols-2">
              <div>
                <dt className="font-mono text-xs font-medium uppercase tracking-[0.12em] text-muted">Base</dt>
                <dd className="mt-2 text-lg font-semibold text-foreground">TI / Suporte técnico</dd>
              </div>
              <div>
                <dt className="font-mono text-xs font-medium uppercase tracking-[0.12em] text-muted">Foco atual</dt>
                <dd className="mt-2 text-lg font-semibold text-foreground">Desenvolvimento Backend</dd>
              </div>
            </dl>

            <div className="mt-8 space-y-8">
              <div>
                <h3 className="font-mono text-xs font-medium uppercase tracking-[0.12em] text-cyan">Principal</h3>
                <div className="mt-3">
                  <TechnologyList technologies={coreTechnologies} />
                </div>
              </div>
              <div>
                <h3 className="font-mono text-xs font-medium uppercase tracking-[0.12em] text-gold">Em expansão</h3>
                <div className="mt-3">
